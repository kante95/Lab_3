...
%We verified the value of output current was according to the table XX by changing the bits of the counter. The comparator is used to determine if the signal is too low or high by enabling or diabling the D-FF.
